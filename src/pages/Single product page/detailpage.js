...
const Detailpage = () => {
  ...
  const getdata = () => {
    axios
      .get(
        `https://iteekapi.doctorsforhealth.co.uk/api/v1/products/byUrl/${params.id}`
      )
      .then((res) => {
  ...
  const getdata2 = (urlName) => {
    axios
      .get(
        `https://iteekapi.doctorsforhealth.co.uk/api/v1/products/category/${urlName}`
      )
      .then((res) => {
        const pageSize = 8;
        const page = 1;
        const pages = Math.ceil(res.data?.length / pageSize);
        const pageData = res.data?.slice(
      ...
      <div className="detailpage-main pb-4 mt-lg-5">
        <div className="container mb-5 pt-lg-4 py-lg-5">
          <div className="row">
                  ...
                  <div className={imagefix}>
                    <div className="col-2 d-flex align-items-center justify-content-center">
                      <div className="container">
                        {products[filterid]?.images.map((item, index) => {
                          return (
                            <div
                              className="row ms-auto mb-2"
                              key={index}
                              onClick={() => seti(index)}
                            >
                              <div className={i === index?"img-box-active":"img-box-1"}>
                                <img
                                  src={`https://iteekapi.doctorsforhealth.co.uk/api/v1/products/images/${item}`}
                                  alt=""
                                ></img>
                              </div>
                            </div>
                    ...
                    <div className="col-10">
                      <div className="img-box-2">
                        <img
                          src={`https://iteekapi.doctorsforhealth.co.uk/api/v1/products/images/${
                            products[filterid]
                              ? products[filterid].images[i]
                              : ""
                          }`}
                          alt=""
                        ></img>
            ...
            <div className="col-lg-6 content-main px-lg-4 mt-3 mt-lg-0">
              <div className="row">
                {loader ? (
                  <>
                    <div className="col-lg-9 col-sm-9 col-12  text-start">
                      <h1>
                        {products[filterid]
                          ? products[filterid].display_name
                          : ""}
                      </h1>
                    </div>
                  ...
                  <div className="row mt-2">
                    <div className="col text-start">
                      <h4>
                        Categories:{" "}
                        {products[filterid]
                          ? products[filterid].category.name
                          : ""}
                      </h4>
                    </div>
                  </div>
                  ...
                  <div className="row mt-1">
                    ...
                    <div className="col d-flex align-items-center justify-content-end">
                      <button
                        ...
                        onClick={() => addtocartsubmit(products[filterid])}
                      >
                        Add to cart
                      </button>
                      <ToastContainer />
                          ...
                          return (
                            ...
                            >
                              <button
                                className={
                                  index === filterid
                                    ? "btn btn-primary d-flex align-items-center justify-content-center py-2 active"
                                    : "btn btn-primary d-flex align-items-center justify-content-center py-2 button-normal"
                                }
                              >
                                <button
                                  style={{
                                    background:
                                      item.attributes[0]?.option_index.option2,
                                  }}
                                  className="color-btn me-2"
                                ></button>{" "}
                                {item.attributes[0]?.option_index.option}
                              </button>
                            </div>
                          );
                        })}
                        ...
                        {products.map((item, index) => {
                          return (
                            <div
                              ...
                              onClick={() => setfilterid(index)}
                            >
                              <button className="btn btn-primary active d-flex align-items-center justify-content-center py-2 button-normal">
                                {item.attributes[0]?.option_index.option}
                              </button>
                            </div>
                          );
                        ...
                        {products.map((item, index) => {
                          return (
                            <div
                              ...
                              onClick={() => setfilterid(index)}
                            >
                              <button className="btn btn-primary d-flex align-items-center justify-content-center py-2 button-normal">
                                <button
                                  style={{
                                    background:
                                      item.attributes[1]?.option_index.option2,
                                  }}
                                  className="color-btn me-2"
                                ></button>{" "}
                                {item.attributes[0].option_index.option}
                        ...
                        {products.map((item, index) => {
                          return (
                            ...
                            >
                              ...
                              >
                                {item.attributes[1]?.option_index.option}
                              </button>
                            </div>
                          );
                        })}
                            ...
                            >
                              <button className="btn btn-primary d-flex align-items-center justify-content-center py-2 button-normal">
                                <button
                                  style={{
                                    background:
                                      item.attributes[2]?.option_index.option2,
                                  }}
                                  className="color-btn me-2"
                                ></button>{" "}
                                {item.attributes[0].option_index.option}
                        ...
                        {products.map((item, index) => {
                          return (
                            ...
                            >
                              ...
                              >
                                {item.attributes[2]?.option_index.option}
                              </button>
                            </div>
                          );
                        })}
                  ...
                  {categorydata.map((item, index) => {
                    return (
                      <div className="col-lg-3 col-6 mb-3" key={index}>
                        <div
                          className={
                            a === index ? "card-1 card-2 g-0" : "card-1 g-0"
                          }
                        >
                          <div
                            className="container py-3 px-lg-4"
                            onClick={() => click(index, item.product.urlName)}
                          >
                            <div className="row text-start">
                            ...
                            <div className="row img-box">
                              <img
                                src={`https://iteekapi.doctorsforhealth.co.uk/api/v1/products/images/${item.product}`}
                                alt=""
                    ...
                    <div className="row my-lg-0 my-4">
                      <div className="col-lg-6 content-center text-start ps-5">
                        <div className="container">
                          ...
                          <div className="row mt-2">
                            <p>
                              The best prices for high-quality renewed goods by
                              sellers we’ve checked and vetted. We don’t mind if
                              you Google us.
                            </p>
                          </div>
